...
import { CcSplitterComponent } from './cc-splitter.component';
import { getInputPositiveNumber, getInputBoolean } from './utils';

@Directive({
  selector: 'cc-splitter-area, [cc-splitter-area]',
  exportAs: 'ccSplitterArea'
})
export class CcSplitterAreaDirective implements OnInit, OnDestroy {
  ...
  private split: CcSplitterComponent) {
