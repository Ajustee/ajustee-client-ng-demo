...
import { IArea, IPoint, IAreaSnapshot, ISplitSideAbsorptionCapacity, IAreaAbsorptionCapacity } from './iterface';
...
export function getElementPixelSize(elRef: ElementRef<HTMLElement>, direction: 'horizontal' | 'vertical'): number {
